...
/// Streamlines loading all ``ModelController/DatabaseModel``s of one Type from the database.
protocol ListController: ModelController {
    ...
    /// - Returns: The potentially modified array of loaded ``ModelController/DatabaseModel``s.
    ...
    /// - Returns: The array of  loaded ``ModelController/DatabaseModel``s.
