...
/// Streamlines updating ``ModelController/DatabaseModel``s on the database.
protocol UpdateController: ModelController {
    ...
    ///   - model: The ``ModelController/DatabaseModel`` which will be updated.
    ...
    ///   - model: The updated ``ModelController/DatabaseModel``.
    ...
    ///   - model: The ``ModelController/DatabaseModel`` which should be updated
