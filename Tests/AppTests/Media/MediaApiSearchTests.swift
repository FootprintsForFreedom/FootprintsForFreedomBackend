...
final class MediaApiSearchTests: AppTestCase, MediaTest, TagTest {
    func testSuccessfulSearchMediaReturnsWhenTextInTitle() async throws {
        let media = try await createNewMedia(title: "Ein besonderer Titel \(UUID())", detailText: "Anderer Text", verifiedAt: Date())
    ...
    func testSuccessfulSearchMediaOnlyReturnsVerifiedMedias() async throws {
        let media = try await createNewMedia(title: "Ein besonderer Titel \(UUID())", detailText: "Anderer Text", verifiedAt: nil)
        try await media.detail.$language.load(on: app.db)
    ...
    func testSuccessfulSearchMediaOnlyReturnsDetailsForSpecifiedLanguage() async throws {
        ...
        let media = try await createNewMedia(title: "Ein besonderer Titel \(UUID())", detailText: "Anderer Text", verifiedAt: Date(), languageId: language.requireID())
        try await media.detail.$language.load(on: app.db)
